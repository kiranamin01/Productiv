...
import {
  ...
  Users,
  Briefcase,
} from "lucide-react"; // Added User, Users, Briefcase
    ...
    <div className="not-prose w-full relative flex flex-col gap-16 px-4 py-24 text-center sm:px-8 overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center gap-8">
        <div className="flex flex-col items-center space-y-2">
          ...
          >
            Affordable plans designed to help you and your team achieve more,
            efficiently.
          </motion.p>
        </div>
                    ...
                    <div className="pt-2">
                      {typeof plan.price[frequency] === "number" ? (
                        <div className="flex items-baseline">
                          <span
                            className={cn(
                              // Added a span for currency symbol
                          ...
                          <NumberFlow
                            ...
                            format={{
                              // style: "currency", // Currency style handled by manual symbol
                              // currency: "INR", // Currency symbol added manually
