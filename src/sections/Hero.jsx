        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            <div className="inline-flex items-center rounded-full border border-border bg-background/80 px-3 py-1 text-sm backdrop-blur-sm">
              ...
              <span className="text-muted-foreground">Version 2.0 is here</span>
          ...
          <motion.h1
            ...
            className="text-balance bg-gradient-to-tl from-primary/10 via-foreground/85 to-foreground/50 bg-clip-text text-center text-4xl tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl text-black"
          >
