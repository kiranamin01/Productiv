...
- Main dashboard components structure
- Pomodoro Timer implementation
- Weather API integration
- Music Player with YouTube integration
- Motivation board with quotes API
...
- YouTube API integration for music
...
Note: This changelog is for react-based project. (branch: react)
